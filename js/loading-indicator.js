/**
 * NC File Converter Loading Indicator
 * Provides a loading overlay when the application is initializing
 */

(function() {
  // Create and add loading overlay immediately when script is loaded
