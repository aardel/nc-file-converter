...
NCConverter.Export = {
  ...
  /**
   * Generate DXF header section - Improved compatibility version
...
`;
  ...
  /**
   * Generate polyline entity from coordinates - Improved compatibility version
...
`;
  ...
  /**
   * Generate line entities from coordinates - Improved compatibility version
   * @param {Array} coordinates - Array of {x,y,z} coordinate objects
...
`;
  ...
  /**
   * Generate circle entity - Improved compatibility version
